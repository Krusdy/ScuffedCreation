...
<p align="center">
  <img src="https://img.shields.io/badge/Platform-Windows%2010%20%7C%2011-blue?style=for-the-badge&logo=windows&logoColor=white" alt="Windows Platform" />
  <img src="https://img.shields.io/badge/Architecture-x64-informational?style=for-the-badge" alt="x64 Architecture" />
  <img src="https://img.shields.io/badge/License-MIT-green.svg?style=for-the-badge" alt="MIT License" />
</p>

> A curated collection of lightweight, standalone utilities and powerful automation software built to optimize and streamline your Windows desktop experience.

---

## 🌟 Key Highlights

- **🚀 Lightweight & Standalone:** Zero bloatware or heavy installation steps—run tools directly.
- **⚡ High Performance:** Designed for ultra-low memory and CPU resource usage.
- **🤖 Smart Automation:** Focus-aware rules, automatic profile management, and background execution.
- **🎨 Modern Dark UI:** Clean, ultra-compact interfaces with Windows dark mode integration.

---

## 🧰 Available Tools

| Tool | Key Capabilities | Release |
| :--- | :--- | :---: |
...
| **[Media Processor](https://github.com/Krusdy/ScuffedCreation/releases/tag/Media-Processor)** | Convert video and audio formats, adjust volume levels, trim videos, mute audio tracks, and batch process images with background cleaning and resizing tools. | [Download](https://github.com/Krusdy/ScuffedCreation/releases/tag/Media-Processor) |
...
| **[Spotify Playlist Fetcher](https://github.com/Krusdy/ScuffedCreation/releases/tag/Spotify-Playlist-Fetcher)** | Extract tracks, metadata, and cover art from Spotify playlists, albums, or tracks, and export them into customized text files or PNG images. | [Download](https://github.com/Krusdy/ScuffedCreation/releases/tag/Spotify-Playlist-Fetcher) |
...
This suite is distributed under the **MIT License**. Feel free to use, modify, and distribute.
